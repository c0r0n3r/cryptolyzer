...
-  **Docstrings** (for Python; or API-doc-friendly comments for other languages) must be created or updated for public
   ...
   -  Don't forget to include
      `versionadded <http://sphinx-doc.org/markup/para.html#directive-versionadded>`__/
      `versionchanged <http://sphinx-doc.org/markup/para.html#directive-versionchanged>`__
