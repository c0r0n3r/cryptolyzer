...
@attr.s
class AnalyzerResultCurves(AnalyzerResultIKE):  # pylint: disable=too-few-public-methods
    """
...
class AnalyzerCurves(AnalyzerDHBase):
    @classmethod
    def get_name(cls):
        return 'curves'
    ...
    @classmethod
    def get_help(cls):
        return 'Check which elliptic curve Diffie-Hellman groups supported by the server(s)'
