...
class PublicKeyX509(PublicKey):
    ...
    def __getattr__(self, name):
        if hasattr(self._certificate, name):
    ...
    def fingerprints(self):
        return {
            mac: utils.bytes_to_colon_separated_hex(self._certificate.fingerprint(hash_algo()))
    ...
    def as_json(self):
        return OrderedDict([
            ...
            ('validity', OrderedDict([
                ...
                ('remaining', str(self.validity_remaining_time)),
            ])),
