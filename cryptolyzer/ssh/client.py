...
from cryptoparser.ssh.subprotocol import SshHostKeyAlgorithmVector
...
def get_dh_public_key():
    ...
    #)
    #return parameters.parameter_numbers().p.to_bytes(1024, byteorder='big')
    #private_key = parameters.generate_private_key()
    #return private_key.public_key().public_numbers().parameter_numbers.p.to_bytes(1024, byteorder='big')
    return int((
            ...
            try:
                ...
                if record.packet.get_message_code() == SshMessageCode.KEXINIT:
                    ...
                    if agreed_key_type == KeyExchange.ECDHE:
                        ...
                        raise NotImplementedError
                    self._l4_client.send(SshRecord(SshECDHKeyExchangeInit(ephemeral_public_key)).compose())
